<div class="card card-default">
    ...
    <!-- /.card-header -->
    <form action="{{route('custom_translation.index')}}" method="get">
        <div class="card-body" id="filter" style="display: none">
            ...
            <a href="{{  route('custom_translation.index') }}" class="btn btn-success"> {{$custom[strtolower('remove_filter')]??"lang not found"}}</a>
        </div>
    </form>
</div>
