                ...
                success: function (res) {
                    ...
                    for (let x in res) {
                        for (let i in res[x]) {
                            if (res[x][i].id) {
                                if (res[x][i].id == city) {
                                    $(`#${ModelId} #city_id`).append(`<option value="${res[x][i].id}" selected>${res[x][i].name}</option>`);
                                } else {
                                    $(`#${ModelId} #city_id`).append(`<option value="${res[x][i].id}">${res[x][i].name}</option>`);
                                }
                            }
                        }
                    }
