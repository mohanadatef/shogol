    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{$custom[strtolower('Social')]??"lang not found"}}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{$custom[strtolower('Home')]??"lang not found"}}</a></li>
                            <li class="breadcrumb-item active">{{$custom[strtolower('Social')]??"lang not found"}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <form method="get" action="">
                <div class="container-fluid">
                    @include('coredata::social.filter')
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            @permission('social-change-status')
                                        ...
                                        @forelse($datas as $data)
                                            <tr id="data-{{$data->id}}">
                                                <td id="name-{{$data->id}}" data-order="{{$data->order}}">{{$data->name->value ?? ""}}</td>
                                                <td>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group{{ $errors->has('order') ? ' is-invalid' : "" }}">
                                ...
                                <div class="form-group{{ $errors->has('logo') ? ' has-error' : "" }}">
                                    <label>{{$custom[strtolower('Logo')]??"lang not found"}}</label>
