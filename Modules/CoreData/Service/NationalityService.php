...
use Modules\CoreData\Http\Resources\Nationality\NationalityResource;
...
class NationalityService extends BasicService
{
    ...
    public function store(Request $request)
    {
        ...
        ActiveLog($data,actionType()['ca'],'nationality');
        return $data;
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        ActiveLog($data,actionType()['ua'],'nationality');
        return new NationalityResource($data);
    }

    public function list (Request $request,$pagination = false , $perPage = 10)
    {
        ActiveLog(null,actionType()['va'],'nationality');
        return NationalityListResource::collection($this->repo->list($request,$pagination,$perPage));
    }
