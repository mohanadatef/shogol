                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form action="{{route('page.update',$data->id)}}" method="post" id="edit" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
...
@section('script_style')
    ...
    @endforeach
    {!! JsValidator::formRequest('Modules\Setting\Http\Requests\Page\EditRequest','#edit') !!}
@endsection
