                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    <input type="radio" @if($data->is_web) checked @endif  name="is_web" value="1" id="radioSuccess1">
                                                    <label for="radioSuccess1">
                                                        {{$custom[strtolower('Active')]??'lang not found'}}
                                                    </label>
                                                </div>
                                                <div class="icheck-danger d-inline">
                                                    <input type="radio" @if(!$data->is_web) checked @endif name="is_web" value="0"  id="radioSuccess2">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    <input type="radio"  @if($data->is_approve) checked @endif   name="is_approve" value="1" id="radioSuccess3">
                                                    <label for="radioSuccess3">
                                                        {{$custom[strtolower('Active')]??'lang not found'}}
                                                    </label>
                                                </div>
                                                <div class="icheck-danger d-inline">
                                                    <input type="radio" @if(!$data->is_approve) checked @endif name="is_approve" value="0"  id="radioSuccess4">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    <input type="radio"  @if($data->is_report) checked @endif  name="is_report" value="1" id="radioSuccess5">
                                                    <label for="radioSuccess5">
                                                        {{$custom[strtolower('Active')]??'lang not found'}}
                                                    </label>
                                                </div>
                                                <div class="icheck-danger d-inline">
                                                    <input type="radio" @if(!$data->is_report) checked @endif name="is_report" value="0"  id="radioSuccess6">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    <input type="radio"  @if($data->is_verified) checked @endif  name="is_verified" value="1" id="radioSuccess7">
                                                    <label for="radioSuccess7">
                                                        {{$custom[strtolower('Active')]??'lang not found'}}
                                                    </label>
                                                </div>
                                                <div class="icheck-danger d-inline">
                                                    <input type="radio" @if(!$data->is_verified) checked @endif name="is_verified" value="0"  id="radioSuccess8">
