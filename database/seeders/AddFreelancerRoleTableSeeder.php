...
class AddFreelancerRoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $permissions =[ 'user-edit',"ad-index","ad-create","ad-edit","ad-show", "ad-delete","ad-cansel","task-index",
        ...
        $role = $this->roleService->findBy(new Request(['name' => 'freelancer']), 'first');
